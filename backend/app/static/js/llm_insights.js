  ...
  items.forEach(item => {
    ...
    html += `
      <tr>
        ...
        <td style="vertical-align: top;"><code style="background: #0f172a; color: #38bdf8; padding: 6px 10px; border-radius: 6px; font-family: var(--font-mono); font-size: 11px; display: block; white-space: pre-wrap; word-break: break-all;">${escapeHtml(cypherShort)}</code></td>
